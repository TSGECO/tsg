...
\begin{tikzpicture}[
	...
	\draw[tsgblue, line width=1.5pt] (-6,12.5) -- (6,12.5);
	...
	% connect javascript to the line between tsg_format and aurora
	\draw[connector] (js) to[out=-90, in=90] ($(tsg_format.west)!0.5!(aurora.east)$);
	...
	\node[legend_box=tsgblue] (legend1) at (6,10) {};
